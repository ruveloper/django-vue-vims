    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("created", models.DateTimeField(auto_now_add=True)),
                ("service", models.CharField(default="No Service", max_length=255)),
                ("image_id", models.CharField(default="No Image ID", max_length=255)),
                ("author", models.CharField(default="No Author", max_length=255)),
                ("name", models.CharField(default="No Name", max_length=255)),
